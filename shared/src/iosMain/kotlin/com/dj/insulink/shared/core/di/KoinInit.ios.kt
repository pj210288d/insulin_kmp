...
// Pokreće Koin za iOS - trenutno samo modul-i koje MVP Glucose/Statistics/Insulin ekrani
// zahtevaju (statisticsModule uključuje i glucoseModule/settingsModule - vidi
...
fun initKoinIOS() {
    ...
    started = true
    startKoin {
        modules(statisticsModule, insulinModule)
    }
